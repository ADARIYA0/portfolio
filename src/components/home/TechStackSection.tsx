...
const techStack = [
  ...
  { name: "MySQL", category: "Database", icon: <img src="/images/tech/mysql.png" alt="MySQL" className="w-8 h-8 object-contain" /> },
  { name: "PhpMyAdmin", category: "Tools", icon: <img src="/images/tech/phpmyadmin.svg" alt="PhpMyAdmin" className="w-8 h-8 object-contain" /> },
