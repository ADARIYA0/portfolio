...
export default function AboutMeSection() {
  return (
    <section className="pb-20 md:pb-32 pt-0 relative" id="about-me">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-y-10 lg:gap-y-0 lg:gap-x-8 relative z-10">
        ...
        <div className="lg:col-span-5 lg:col-start-8 lg:row-start-1 lg:row-span-2 flex justify-center lg:justify-end items-start lg:pt-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            ...
            <div className="absolute inset-0 rounded-xl overflow-hidden bg-zinc-200 dark:bg-zinc-800 transition-all duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1 z-10">
              <div className="absolute inset-0 bg-blue-600/20 mix-blend-multiply group-hover:bg-transparent transition-colors duration-300 z-20" />
              <Image
        ...
        <div className="lg:col-span-7 lg:col-start-1 lg:row-start-2 text-zinc-600 dark:text-zinc-400">
          ...
          >
            <p>
              Hello! My name is Adrian and I enjoy creating things that live on the internet. My interest in software engineering started back when I was fascinated by how computers worked—it wasn&apos;t just about using them, but figuring out how the pieces fit together behind the screen.
            </p>
